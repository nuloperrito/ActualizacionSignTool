...
public class Form1 : Form
{
    ...
    private void button2_Click(object sender, EventArgs e)
    {
        ...
        {
            string directory = folderBrowser.SelectedPath;//Path.GetDirectoryName();
            string[] files = Directory.GetFiles(directory, "*.exe", SearchOption.AllDirectories)
                .Concat(Directory.GetFiles(directory, "*.dll", SearchOption.AllDirectories))
                .Concat(Directory.GetFiles(directory, "*.sys", SearchOption.AllDirectories)).ToArray();
    ...
    private void MyDragDrop(object sender, DragEventArgs e)
    {
        ...
        foreach (string path in droppedPaths)
        {
            if (Directory.Exists(path))
            {
                ...
                filesToProcess.AddRange(filesInFolder);
            }
        ...
        {
            processAtBackground(filesToProcess.ToArray());
        }
    }
